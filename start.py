...
def db_select(choice,choice1,choice2,choice3,choice4):
    conn = psycopg2.connect(host="ec2-44-205-112-253.compute-1.amazonaws.com", dbname="dcdfbmcp09gmcc", user="axliyegodnehag", password="9ef8dab9260e8b0c8642f9ad7dca998ccc3f53760f6ad3285310e5f0973b9c06")
